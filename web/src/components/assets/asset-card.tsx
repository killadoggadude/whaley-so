...
export function AssetCard({
  ...
  if (viewMode === "list") {
    return (
      <div
        className={cn(
          "group flex items-center gap-4 rounded-lg bg-card border border-border p-3 cursor-pointer transition-colors duration-200 hover:bg-[oklch(0.11_0_0)]",
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden rounded-lg bg-card border border-border cursor-pointer transition-colors duration-200 hover:bg-[oklch(0.11_0_0)]",
